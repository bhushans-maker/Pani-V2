...
export default function Dashboard() {
  ...
  const startSystemTest = async () => {
    ...
    setTimeout(async () => {
      setIsTesting(false);
      // playAlarmNow plays ringtone + vibration DIRECTLY in the native layer
      // No ForegroundService needed — works immediately while app is open
      await alarmNativeManager.playAlarmNow('🔔 System Test: Drink water now!');
